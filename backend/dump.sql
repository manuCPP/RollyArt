...
INSERT INTO migrations VALUES(4,'2025_06_27_094028_create_operas_table',1);
INSERT INTO migrations VALUES(5,'2025_06_27_100335_create_personal_access_tokens_table',1);
...
CREATE TABLE IF NOT EXISTS "operas" ("id" integer primary key autoincrement not null, "title" varchar, "author" varchar, "tecnique" varchar, "date" varchar, "price" varchar, "dimension" varchar, "imgPath" varchar, "isSold" tinyint(1) not null, "created_at" datetime, "updated_at" datetime);
